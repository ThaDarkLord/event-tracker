        ...
        .then(function (data) {
            ...
            if (!data._embedded) {
                ...
                for (let i = 0; i < data._embedded.events.length; i++) {
                    ...
                    if (data._embedded.events[i]._embedded.venues[0].state.stateCode) {
                        ...
                        eventCityPara.textContent = "City: " +
                            data._embedded.events[i]._embedded.venues[0].city.name;
                    }
                    eventVenuePara.textContent =
                        "City: " + data._embedded.events[i]._embedded.venues[0].name;
...
// TODO: Add city search functionality
// fetch(cityEvents)
// .then(function (response) {
//     return response.json()
// })
